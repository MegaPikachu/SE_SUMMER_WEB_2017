...
public class ContacterServiceImpl implements ContacterService {
	...
	public String addfriend(int uid1, int uid2, String remark) {
		...
		Contacter addContacter1 = new Contacter(uid1, uid2, remark, (short)1);
	...
	public String addfriend(int uid1, int uid2, String remark1, String remark2) {
		String name1 = (userDao.getUserById(uid1)).getUsername();
		String name2 = (userDao.getUserById(uid2)).getUsername();
		Contacter addContacter1 = new Contacter(uid1, uid2, remark1, (short)1);
		if (contacterDao.duplicate(addContacter1) == 1) {
			return "failed";
		}
		else{
			contacterDao.save(addContacter1);
			Contacter addContacter2 = new Contacter(uid2, uid1, remark2, (short)1);
			contacterDao.save(addContacter2);
			return "success";
		}
	}
	...
	public String check(int uid1, int uid2) {
		Contacter contacter = contacterDao.getContacterByIds(uid1, uid2);
		if(contacter!=null)
			return "true";
		return "false";
	}
